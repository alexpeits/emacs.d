...
(let ((class '((class color) (min-colors 89)))
   ...
   'monokrom
	...
	`(cursor ((,class (:background ,fg3))))
        ...
        `(mode-line ((,class (:foreground ,fg2 :background ,bg4 :box (:line-width 2 :color "#2d2d2d")))))
        `(mode-line-inactive ((,class (:inherit mode-line :foreground "#656565" :background "#202020"))))
