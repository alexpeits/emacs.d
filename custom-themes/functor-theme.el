...
(let* ((builtin       (if functor-theme-less-colors
  ...
  (custom-theme-set-faces
   ...
   `(powerline-active0               ((t ,powerline-active0)))
   `(powerline-active1               ((t ,powerline-active1)))
   `(powerline-active2               ((t ,powerline-active2)))
   `(powerline-inactive0             ((t ,powerline-inactive0)))
   `(powerline-inactive1             ((t (:inherit powerline-inactive0))))
   `(powerline-inactive2             ((t (:inherit powerline-inactive0))))
   `(powerline-active0-evil-insert   ((t ,powerline-active0-evil-insert)))
   `(powerline-active0-evil-visual   ((t ,powerline-active0-evil-visual)))
   `(powerline-active0-evil-replace  ((t ,powerline-active0-evil-replace)))
   `(powerline-active0-evil-operator ((t ,powerline-active0-evil-operator)))
   `(powerline-active0-evil-emacs    ((t (:inherit powerline-active0-evil-operator))))
   `(powerline-active2-edited        ((t ,powerline-active2-edited)))
