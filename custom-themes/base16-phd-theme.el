...
There are two choices for applying the emphasis:
  ...
  :type '(choice (const :tag "Contrast" contrast)
                 (const :tag "Off" nil)
...
;;;; isearch
     ...
     (isearch                                      :foreground base0F :background base01 :inverse-video t)
     (lazy-highlight                               :foreground base03 :background base00 :inverse-video t)
...
;;;; line-numbers
     (line-number                                  :foreground base03 :background "#1d273b")
     (line-number-current-line                     :foreground base03 :background "#2d374b")
...
;;;; linum-mode
     (linum                                        :foreground base03 :background "#1d273b")
