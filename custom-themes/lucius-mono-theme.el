...
(custom-theme-set-faces
 ...
 ;; `(font-lock-comment-face              ((t (:foreground "#6a9955" :background nil :slant italic))))
 `(font-lock-comment-face              ((t (:foreground "#868686" :background nil :slant italic))))
 ...
 '(font-lock-warning-face              ((t (:foreground "#cb5a37" :background nil))))
