...
(custom-theme-set-faces
 ...
 '(mode-line-inactive  ((t (:foreground "#676d61" :background "#292f2a"))))
 ...
 '(outline-5 ((t (:inherit font-lock-builtin-face))))
 '(outline-6 ((t (:inherit font-lock-keyword-face :weight normal))))
