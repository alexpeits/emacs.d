...
(custom-theme-set-faces
 ...
 `(font-lock-variable-name-face        ((t (:foreground "#69e03e" :background nil                                                                ))))
 ...
 ;; `(haskell-constructor-face            ((t (:foreground "#97b2c4"))))
 ...
 '(mode-line ((t (:foreground "#b3cbdb" :background "#233a49" :box (:line-width 1 :color "#263f4f")))))
 '(mode-line-inactive ((t (:inherit mode-line :foreground "#386a7a" :background "#19232d"))))
