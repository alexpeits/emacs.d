...
(defmacro hemingway-with-color-variables (variant &rest body)
  ...
  `(let* ((class '((class color) (min-colors 89)))
         ...
         (yellow (if (eq variant 'light) "#719797" "#92BFBF"))
         (orange    "#cb4b16")
         (red       "#dc322f")
         (magenta   "#d33682")
         (violet (if (eq variant 'light) "#6B9434" "#99C35E"))
         (blue (if (eq variant 'light) "#968963" "#C1B286"))
         (cyan (if (eq variant 'light) "#6B9389" "#99C5BA"))
         (green     "#c99672")
...
;;;;; flycheck
     ...
     `(flycheck-warning
       ((,(append '((supports :underline (:style wave))) class)
         (:underline (:style wave :color ,yellow-lc) :inherit unspecified))
        (,class (:foreground ,yellow-hc :background ,yellow-lc :weight bold :underline t))))
     `(flycheck-info
       ((,(append '((supports :underline (:style wave))) class)
         (:underline (:style wave :color ,(if hemingway-emphasize-indicators
                                              blue-l base03)) :inherit unspecified))
...
;;;;; org-mode
     ...
     `(org-block ((,class (:background ,base04))))
     `(org-block-begin-line ((,class (:foreground ,base1 :background ,base05 :slant italic))))
     `(org-block-end-line ((,class (:foreground ,base1 :background ,base05 :slant italic))))
...
;;;;; perspective
     `(persp-selected-face ((,class (:foreground ,blue))))
;;;;; pretty-mode
